 ...
 *   const col = client.models(dbName).collection('createIndexExample1');
...
Collection.prototype.find = deprecateOptions(
  ...
  function(query, options, callback) {
    ...
    // // If we have overridden slaveOk otherwise use the default models setting
    ...
    // Add models object to the new options
...
/**
 * Creates an index on the models and collection collection.
 * @method
 ...
 * @return {Promise} returns Promise if no callback passed
 * @example
 * const collection = client.models('foo').collection('bar');
 *
 ...
 * @method
 * @deprecated use models.command instead
 * @param {Object} [options] Optional settings
 * @param {ClientSession} [options.session] optional session to use for this operation
 * @param {Collection~resultCallback} [callback] The command result callback
 * @return {Promise} returns Promise if no callback passed
...
}, 'collection.reIndex is deprecated. Use models.command instead.');
...
/**
 * An estimated count of matching documents in the models to a query.
 *
