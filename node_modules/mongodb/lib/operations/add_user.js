...
class AddUserOperation extends CommandOperation {
  ...
  _buildCommand() {
    ...
    // Check the models name and add roles if needed
    if (
  ...
  execute(callback) {
    ...
    if (options.digestPassword != null) {
      return callback(
        toError(
          "The digestPassword option is not supported via add_user. Please use models.command('createUser', ...) instead for this option."
        )
      );
    }
