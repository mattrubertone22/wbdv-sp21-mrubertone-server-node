 ...
 *   const gridStore = new GridStore(models, null, "w");
 *   gridStore.open(function(err, gridStore) {
 *     gridStore.write("hello world!", function(err, gridStore) {
 *       gridStore.close(function(err, result) {
 *         // Let's read the file using object Id
 *         GridStore.read(models, result._id, function(err, data) {
 ...
 *
 * (models, name, callback)
 * (models, name, length, callback)
 * (models, name, length, offset, callback)
 * (models, name, length, offset, options, callback)
 *
 * @method
 * @static
 * @param {Db} db the database to query.
