 ...
 *   const testDb = client.models(dbName);
 *   client.close();
 * });
 */
 ...
 * @property {(Server|ReplSet|Mongos)} serverConfig Get the current models topology.
 * @property {number} bufferMaxEntries Current bufferMaxEntries value for the database
 * @property {string} databaseName The name of the database this instance represents.
 * @property {object} options The options associated with the models instance.
 * @property {boolean} native_parser The current value of the parameter native_parser.
 * @property {boolean} slaveOk The current slaveOk value for the models instance.
...
function Db(databaseName, topology, options) {
  ...
  // Internal state of the models object
  this.s = {
    // DbCache
    dbCache: {},
    // Children models's
  ...
  // Ensure we have a valid models name
  ...
  // This is a child models, do not register any listeners
...
/**
 * Return the Admin models instance
 * @method
 * @return {Admin} return the new Admin models instance
 */
 ...
 * can use it without a callback in the following way: `const collection = models.collection('mycollection');`
 *
 * @method
...
Db.prototype.collection = function(name, options, callback) {
  ...
  // If we have not set a collection level readConcern set the models level one
  ...
  // Merge in all needed options and ensure correct writeConcern merging from models level
...
/**
 * Get the list of all collection information for the specified models.
 *
 * @method
...
/**
 * Fetch all collections for the current models.
 *
 * @method
 * @param {Object} [options] Optional settings
 * @param {ClientSession} [options.session] optional session to use for this operation
...
/**
 * Creates an index on the models and collection.
 * @method
...
/**
 * Return the models logger
 * @method
 * @return {Logger} return the models logger
 * @ignore
 */
